<div class="panel panel-flat">
	...
	<div class="panel-heading">
		<h5 class="panel-title">Add Professor</h5>
	</div>

	<div class="panel-body">

		<form class="form-horizontal" action="<?php echo URL?>professor/add" id="professor_form">
...
<script type="text/javascript" src="<?php echo APPJS?>registrar/professor_add.js?v=<?php echo VERSION?>"></script>